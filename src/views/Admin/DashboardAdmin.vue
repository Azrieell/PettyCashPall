<template>
  <!-- component -->
  <div>
    <div class="mt-20 grid grid-cols-1 gap-5 sm:grid-cols-1 lg:grid-cols-3 ml-64"> <!-- Tambahkan margin kiri di sini -->
      <div class="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-12 pt-5 shadow sm:px-6 sm:pt-6 overflow-y-auto">
        <dt>
          ...
          <p class="ml-16 truncate text-sm font-medium text-gray-300">Registered account</p>
        </dt>
        <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
          <p class="text-2xl font-semibold text-gray-100">71,897</p>
          <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6" style="margin-left: 25%; padding-right: 2rem;"> <!-- Sesuaikan padding-right di sini -->
            <div class="text-sm">
