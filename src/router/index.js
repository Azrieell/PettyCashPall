  ...
  import DataUsers from "../views/Admin/DataUsers.vue";
  import SingleArticleMain from "../components/Main/SingleArticleMain.vue";
  ...
  const routes = [{
    ...
    {
      path: "/article/:id",
      component: SingleArticleMain,
      name: "SingleArticleMain",
      meta: {
