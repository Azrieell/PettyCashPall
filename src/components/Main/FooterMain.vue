<template>
  <footer class="px-4 divide-y bg-gray-200 dark:border-black dark:text-black mt-24">
      ...
      <div class="lg:w-1/3">
        <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
          <div class="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="flex-shrink-0 w-5 h-5 rounded-full dark:text-black">
              <path d="M18.266 26.068l7.839-7.854 4.469 4.479c1.859 1.859 1.859 4.875 0 6.734l-1.104 1.104c-1.859 1.865-4.875 1.865-6.734 0zM30.563 2.531l-1.109-1.104c-1.859-1.859-4.875-1.859-6.734 0l-6.719 6.734-6.734-6.734c-1.859-1.859-4.875-1.859-6.734 0l-1.104 1.104c-1.859 1.859-1.859 4.875 0 6.734l6.734 6.734-6.734 6.734c-1.859 1.859-1.859 4.875 0 6.734l1.104 1.104c1.859 1.859 4.875 1.859 6.734 0l21.307-21.307c1.859-1.859 1.859-4.875 0-6.734z"></path>
            </svg>
          </div>
          <span class="self-center text-2xl font-semibold">PettyCashPall</span>
        </a>
      </div>
      <div class="grid grid-cols-2 lg:grid-cols-4 text-sm gap-x-3 gap-y-8 lg:w-2/3">
        <div class="space-y-3">
          <h3 class="tracki uppercase dark:text-black">Product</h3>
          <ul class="space-y-1">
            <li>
        ...
        <div class="space-y-3">
          <h3 class="tracki uppercase dark:text-black">Company</h3>
          <ul class="space-y-1">
            <li>
        ...
        <div class="space-y-3">
          <h3 class="uppercase dark:text-black">Developers</h3>
          <ul class="space-y-1">
            <li>
        ...
        <div class="space-y-3">
          <div class="uppercase dark:text-black">Social media</div>
